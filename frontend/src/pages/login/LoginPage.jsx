          ...
          <div className='flex flex-col gap-11 justify-center items-center mt-7 pl-11 pr-11 mb-11'>
            <form onSubmit={handleSubmit}>
              <div className='flex flex-col gap-6'>
                ...
                <input type="text" id='email' name='email' value={email} onChange={(e)=>setEmail(e.target.value)} className='block outline-none  border border-gray-700 rounded-3xl  w-[350px] sm:min-w-[400px] pl-4 pr-4 pt-2 pb-2'/>
              </div>
                
              <div className='flex flex-col gap-6 mt-7'>
                <label htmlFor="password">Password</label>
                <input type="password" id='password' name='password' value={password} onChange={(e)=>setPassword(e.target.value)} className='block outline-none rounded-3xl sm:min-w-[400px] border w-[350px] border-gray-700 pl-4 pr-4 pt-2 pb-2'/>
              </div>
              ...
              <div className='flex gap-6 mt-7 items-center'>
                ...
                >Submit</button>
                <span className='hover:underline hover:cursor-pointer hover:opacity-75'>New User ? <Link to='/signup'>create account</Link></span>
              </div>
            </form>
